    ...
    <div className="bg-ltgreen" style={{ backgroundImage: `url(${greenbg})` }}>
      <div className="w-full h-[10%] py-10 flex flex-col justify-center text-dkbrown items-center space-y-5">
        ...
        <div className="font-NBI w-[80%] md:w-[70%] p-5 md:p-10 text-center text-xl md:text-2xl">
          <p>
            ...
            Himachal Pradesh, Woodward 2 is more than just a place to stay—it's
            an experience designed to connect you with nature, adventure, and
            serenity. Our boutique hotel offers a blend of rustic charm and
            modern comforts, making it a sanctuary for travelers seeking
            tranquility and inspiration in the heart of the Himalayas.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center space-y-10 md:space-x-10 md:space-y-0 p-10 md:p-20">
        <div className="flex flex-col justify-center items-center w-full md:w-[40vw] h-[70vh] p-5 md:p-10 rounded-3xl  space-y-5">
          <div className="bg-greenish border-4 rounded-2xl w-full md:w-[80%] h-[50%] p-5 md:p-10 flex flex-col justify-center text-lg md:text-xl">
            <p>
        ...
        <div className="w-full md:w-[40vw] h-[70vh] p-5 md:p-10 bg-greenish border-4 border-darkgreen rounded-3xl">
          <iframe
