...
function Location() {
  return (
    ...
    style={{ backgroundImage: `url(${greenbg})` }}>
      ...
      <span className="flex justify-center items-center  space-x-20 p-20 font-NBI text-dkkbrown">
        <div className="flex flex-grow flex-col justify-center items-center w-[40vw] h-[70vh] p-10 rounded-3xl bg-darkgreen space-y-10">
          <div className="bg-greenish border-4 rounded-2xl w-[80%] h-[50%] p-10 flex flex-col flex-wrap space-y-5 justify-center text-xl">
            <p>
          ...
          <div className="bg-dkbrown hover:bg-dkkbrown text-xl rounded-lg w-[80%] h-[10%] text-center flex justify-center items-center text-white">
        ...
        <div className="flex flex-grow justify-center rounded-3xl items-center w-[40vw] h-[70vh] p-10 bg-darkgreen">
          <iframe
